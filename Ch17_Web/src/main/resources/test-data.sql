...
insert into contact (first_name, last_name, birth_date) values ('Yeonho', 'Jang' , '1973-09-18');

insert into contact (first_name, last_name, birth_date) values ('Mijung', 'Hong' , '1978-01-12');

insert into contact (first_name, last_name, birth_date) values ('Eunchae', 'Jang' , '2009-02-11');

insert into contact (first_name, last_name, birth_date) values ('Eunyu', 'Jang' , '2013-07-25');
